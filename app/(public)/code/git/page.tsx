...
export default function Page() {
  return (
    <div className="flex h-full w-full flex-col flex-nowrap ">
      ...
      />
      <div className="m-4 flex-auto rounded-2xl border-2 border-white bg-[#f0efe7] p-5 text-[#4e443c] ">
        <ul className="space-y-2 font-medium">
          <li>
            <a
              href="/code/git/overview"
              className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
            ...
            <ul id="dropdown-example" className="space-y-2 py-2 indent-4">
              <li>
                <a
                  ...
                  className="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  Version
                </a>
              </li>
