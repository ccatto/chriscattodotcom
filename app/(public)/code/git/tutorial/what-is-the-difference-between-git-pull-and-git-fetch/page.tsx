...
export const metadata: Metadata = {
  title: 'What is the Difference Between git pull and git fetch simply explained ChrisCatto.com documentation',
  description: 'What is the Difference Between git pull and git fetch simply explained ChrisCatto.com documentation Git Tutorial',
  alternates: {
