...
export const metadata: Metadata = {
  ...
  description: 'Chris Catto Next.js Fundamentals Tutorial',
};
      ...
      <div className="flex h-full w-full flex-col flex-nowrap ">
        <div className="flex-none">
          <JumbotronCattoFlexible
            ...
            description="Next.js Fundamentals including a hello world / create app example; Routing; Navigation; ect."
          />
        </div>
        <hr className="p-0" />
