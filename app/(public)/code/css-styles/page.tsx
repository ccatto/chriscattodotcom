      ...
      <div className="flex h-full w-full flex-col flex-nowrap ">
        <div className="flex">
          <JumbotronCattoFlexible
            title="CSS & Styling"
            description="CSS & Styling are the look and feel of the app."
          />
        </div>
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3">This is a great CSS Tutorial page on web.dev/learn/css</span>
              </Link>
            </li>
            ...
            {/* <li>
              ...
              <ul id="dropdown-example" className="space-y-2 py-2 indent-4">
                <li>
                  <a
                    href="/code/css-styles/fundamentals/helloworld"
                ...
                <li>
                  <a
                    href="/code/css-styles/fundamentals/functions"
                    className="group flex w-full items-center rounded-lg p-2 pl-11 transition duration-75 hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white"
                  >
                    Functions
                  </a>
                ...
                <li>
                  <a
                    href="/code/css-styles/fundamentals/objects"
                    className="group flex w-full items-center rounded-lg p-2 pl-11 transition duration-75 hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white"
                  >
                    Objects
                  </a>
