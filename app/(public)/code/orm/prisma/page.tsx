      ...
      <div className="flex flex-col flex-nowrap h-full w-full ">
        ...
        <div className='flex-[80] m-4 p-4 rounded-2xl dark:bg-[#0064a5] text-black ring-2 ring-gray-300 dark:ring-gray-500'>
          <ul className="space-y-2 font-medium">
            <li>
              <Link href="/code/orm/prisma/overview" className="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white group">
                ...
                <div>
                  ...
                  Baseline db
                  Create directory : prisma/migrations/0_init
                  Then run following:
...
{/* npx prisma migrate diff --from-empty --to-schema-datamodel prisma/schema.prisma --script > prisma/migrations/0_init/migration.sql */}
                  ...
                  To make changes: prisma migrate dev
