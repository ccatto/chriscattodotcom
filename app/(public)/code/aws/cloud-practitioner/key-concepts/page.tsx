      ...
      <div className="flex h-full w-full flex-col flex-nowrap ">
        ...
        <div className="m-4 flex-[80] rounded-2xl p-4 text-white ring-2 ring-gray-300 dark:bg-[#232f3e] dark:ring-gray-500">
          ...
          <div>
            ...
            <div>
              AWS feature reducing the TCO (total cost of ownership) AWS Cloud
              benefit: ability to focus on revenue-generating activities;
            ...
            <div>
              ...
              dynamic user demand - Elasticity - makes feasible to add remove
              resources Pay-as-you-go pricing - pay only upon usage;
            </div>
            <div>
              AWS Config - Assess; audit & evaluate configurations resources.
              https://aws.amazon.com/config/ Config is good to "Audit" change
            ...
            <div>
              AWS Cloud feature - agility: Agility - "Quickly" deliver new
              functionality in an iterative manner minimizing the time to market
              an example of AWS agility is decreased acquisition time for new
              compute resources; ability to scale up & down during peek times;
            </div>
            <div>
            ...
            <div>
              ...
              best would be "Spot Instances". https://aws.amazon.com/ec2/spot/
            ...
            <div>
              ...
              address security gaps; AWS Trusted Advisor can be run & review the
              findings with will Determine if any security groups in AWS have
              been provisioned to allow unrestricted access for specific ports
              by Ex. 2 categories: Instance Usage & Performance
            </div>
            <div>
            ...
            <div>
              Architecture Design Principles: * ex. - using many instances in
              parallel is a good approach to transcoding a large number of video
              files.
              ...
              components * design for scalability - Design for failure principle
          ...
          <div>
            ...
            <div>
              ...
              Customers responsible for security "IN" the cloud: * patching EC2
              instances; * data encryption AWS responsible for security "OF" the
              cloud: * has sole responsibility for physical security; "Security
              of the Cloud" * AWS is responsible for protecting the
              infrastructure that runs all of the services offered in AWS Cloud;
              * updating firmware
            </div>
            <div>
            ...
            <div>
              ...
              https://aws.amazon.com/security/penetration-testing/ We request &
              wait for approval from AWS internal security team.
            </div>
          </div>
          ---------------- ----------------------- -- 3. Services & Cloud
          technology --- ---------------- -----------------------
          <div>
            <div>
              IAM - adds security & identity * MFA & enforcing pw strength &
            ...
            <div>
              ...
              Amazon Elastic File System EFS https://aws.amazon.com/efs/ * EFS
              provides simple scalable elastic NFS file system & can be used for
              on-premises including Linux Glacier is used for archiving | long
            ...
            <div>
              ...
              https://aws.amazon.com/s3/ * can be used for hosting static
              websites;
            ...
            <div>
              ...
              https://aws.amazon.com/ebs/ is a device you can mount onto EC2 it
              is a block storage so you format it; we are able to chose which
              type of file we want.
            </div>
            <div>
            ...
            <div>
              ...
              retention https://aws.amazon.com/cloudwatch/
            ...
            <div>
              ...
              * can be used to serve large amounts of online video with lowest
              possible latency https://aws.amazon.com/cloudfront/
            </div>
            <div>
          ...
          <div>
            <div>
              AWS Support Plans: ex. Business - minimum that allows one hour
              response time https://aws.amazon.com/premiumsupport/plans/ *
              Enterprise * Business * Developer * Basic
            </div>
            <div>
              EC2 Pricing models: On-Demand instances in EC2 Pricing model is
              MOST cost efficient for an uninterruptible workload that runs once
              a year for 24 hours Reserved instances are not cheap; save up to
              75% Spot instances: * can be interrupted; * can save up to 90%; *
              adjusts based on demand;
            </div>
            <div>
              AWS Artifact - access AWS & ISV security & compliance reports
              https://aws.amazon.com/artifact/ ex. we can download compliance &
              certification reports;
            </div>
            <div>
              BILLING AWS Organizations - centrally manage environments &
              multiple AWS accounts https://aws.amazon.com/organizations/ ex. if
              customer is using multiple AWS accounts with separate billing to
