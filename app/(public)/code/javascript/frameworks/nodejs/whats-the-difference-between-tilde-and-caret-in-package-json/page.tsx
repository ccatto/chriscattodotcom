...
export const metadata: Metadata = {
  title: 'Whats the Difference Between ~ Tilde and ^ Caret in Package-json Simple Explanation documentation ChrisCatto.com',
  ...
  return (
    <>
      ...
      <div className="m-4 flex-[80] rounded-2xl p-4 text-white ring-2 ring-gray-300 dark:bg-black dark:ring-gray-500">
        ...
        <p>
          <Link href="https://docs.npmjs.com/cli/v8/configuring-npm/package-json#dependencies" target='_blank'  className="font-medium text-blue-600 hover:underline dark:text-blue-500">
