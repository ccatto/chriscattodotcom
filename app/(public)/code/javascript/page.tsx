    ...
    <div className="flex flex-col flex-nowrap h-full w-full ">
      <div className='flex-0'>
        <JumbotronCattoFlexible
          title="JavaScript"
          description="JavaScript has become so important & large; this page is my way of trying to define; outline & learn .js"
        />
      </div>
      <div className='flex-1 p-5 m-5 border-2 border-white rounded-2xl text-slate-200 '>
        <ul className="space-y-2 font-medium">
          <li>
            <a href="/code/javascript/overview" className="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white group">
          ...
          <li>
            <a href="/code/git/installation" className="flex items-center p-2 rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white group">
          ...
          <li>
            ...
            <ul id="dropdown-example" className="indent-4 py-2 space-y-2">
              <li>
                <a href="/code/git/version" className="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white">
                  Hello World
                </a>
              </li>
              <li>
                <a href="/code/git/status" className="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white">
                  Code; variables; types; loops; functions; switch
                </a>
              </li>
              <li>
                <a href="/code/git/log" className="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white">
                  Code Quality
                </a>
              </li>
              <li>
                <a href="/code/git/branch" className="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white">
                  Objects
                </a>
              </li>
              <li>
