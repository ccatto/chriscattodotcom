          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              <ul id="dropdown-example" className="indent-4 py-2 space-y-2">
                ...
                <li>
                  <a href="/code/javascript/fundamentals/objects" className="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white">
                    Objects
                  </a>
                </li>
              </ul>
