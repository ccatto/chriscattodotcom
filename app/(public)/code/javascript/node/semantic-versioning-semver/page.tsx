...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.chriscatto.com/code/javascript/node/semantic-versioning-semver',
  },
};
    ...
    <>
      <div className="flex h-full w-full flex-col flex-nowrap ">
        ...
        <div className="m-4 flex-[80] rounded-2xl p-4 text-black ring-2 ring-gray-300 dark:bg-[#f7df1e] dark:ring-gray-500">
          ...
          <p>Given a version number MAJOR.MINOR.PATCH, (ex. 2.4.1):</p>
          <ol>
          ...
          <p>
            ...
            <CommandPromptDisplay
              ...
              output="info Current version: 1.0.0 \n info New version: 1.1.0"
            />
          </p>
        </div>
