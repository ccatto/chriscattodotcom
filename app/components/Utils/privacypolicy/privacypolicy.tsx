const PrivacyPolicy = () => {
  return (
    <>
      <div>
        <div className="m-3 mb-8 rounded-lg border border-gray-200 bg-gray-50 p-8 text-gray-400 dark:border-gray-700 dark:bg-gray-800 md:p-12">
          <div>
            <h1 className="mb-2 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl">
              PRIVACY POLICY
            </h1>
            <p>Last updated November 17, 2006</p>
            <br />
            <p>
              This privacy notice for ChrisCatto.com ("we," "us," or "our"),
            ...
            <ul className="max-w-md list-inside list-disc space-y-1 text-gray-500 dark:text-gray-400">
              <li>
                Visit our website at http://www.ChrisCatto.com, or any website
          ...
          <br />
          <div>
            <h3 className="font-bold">SUMMARY OF KEY POINTS</h3>
            <br />
            <p>
          ...
          <p>
            ...
            categories of sensitive information: Social Media Login Data. We may
          ...
          <br />
          <div>
            In Short: If you are a resident of California or Utah, you are
            ...
            <br />
            <div>
              Category Examples Collected A. Identifiers Contact details, such
              ...
              Protocol address, email address, and account name NO B. Personal
              information as defined in the California Customer Records statute
              Name, contact information, education, employment, employment
              history, and financial information NO C. Protected classification
              characteristics under state or federal law Gender and date of
              birth NO D. Commercial information Transaction information,
              ...
              or other similar network activity Browsing history, search
              history, online behavior, interest data, and interactions with our
              and other websites, applications, systems, and advertisements NO
              G. Geolocation data Device location NO H. Audio, electronic,
              visual, thermal, olfactory, or similar information Images and
              ...
              professional qualifications if you apply for a job with us NO J.
              ...
              preferences and characteristics NO L. Sensitive personal
              Information NO
            </div>
            <br />
            <p>
