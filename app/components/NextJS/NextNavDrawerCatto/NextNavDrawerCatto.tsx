...
// import JSSideNavLinkList from '../NextJSSideNavLinkList/NextJSSideNavLinkList';
import NextJSSideNavLinkList from '../NextJSSideNavLinkList/NextJSSideNavLinkList';

const NextJSDrawerCatto = () => {
...
export default NextJSDrawerCatto;
