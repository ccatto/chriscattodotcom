...
const FooterCatto = () => {
  return (
    <>
      <footer className="bg-white p-6 dark:bg-gray-900 w-full">
          ...
          <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <Link href="/" className="flex items-center">
                  ...
                  />
                  <span className="self-center whitespace-nowrap text-lg font-semibold dark:text-white lg:text-2xl">
                    ChrisCatto.com
                  </span>
                  <Image
              ...
              <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
                <div>
                  ...
                  <ul className="font-medium text-gray-500 dark:text-gray-400">
                    <li className="mb-4">
                      <Link href="/code/javascript" className="hover:underline">
                        Javascript
                      </Link>
                    </li>
                    <li>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400 sm:text-center">
                © 2006 - {new Date().getFullYear()} Chris Catto .com™. All
                Rights Reserved.
              </span>
              <div className="mt-4 flex sm:mt-0 sm:justify-center">
                {/* https://tw-elements.com/docs/standard/components/social-buttons/ */}
                <a
                  href="https://github.com/ccatto"
                  target="_blank"
                ...
                <a
                  href="https://stackoverflow.com/users/17877/catto"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/catto/"
                  target="_blank"
                  className="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                  <span className="[&>svg]:h-5 [&>svg]:w-5">
                ...
                <a
                  href="https://www.youtube.com/watch?v=vnqy4wR6QII&list=PLC1889B5D1F4DDD7A"
                  target="_blank"
                  className="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                  <span className="[&>svg]:h-5 [&>svg]:w-5">
                ...
                <a
                  href="https://www.facebook.com/chriscattodotcom/"
                  className="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white"
                  target="_blank"
                >
                  <span className="[&>svg]:h-5 [&>svg]:w-5">
                ...
                <a
                  href="https://www.instagram.com/chriscattousa"
                  target="_blank"
                  className="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                  <span className="[&>svg]:h-5 [&>svg]:w-5">
