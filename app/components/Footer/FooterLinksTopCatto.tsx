      ...
      <div className="grid grid-cols-1 gap-8 rounded-3xl bg-slate-800 px-4 py-6 md:grid-cols-4 lg:py-8">
          ...
          <ul className="font-medium text-gray-500 dark:text-gray-400">
            ...
            <li className="mb-4">
              <Accordion type="single" collapsible defaultValue="item-1">
                <AccordionItem value="item-1">
                  <AccordionTrigger>
                    <span className="pl-2">JavaScript Topics2</span>
                  </AccordionTrigger>
                  <AccordionContent>
                    <ul>
                      {/* JS Overview */}
                    ...
                    <ul>
                      <li className="-scroll-mt-3">
                        ...
                        >
                          ...
                          <span className="ms-3">.NET Overview</span>
                        </Link>
                      </li>
                      <li>
                        <Link
                        ...
                        >
                          ...
                          <span className="ms-3">.NET v9</span>
                        </Link>
                      </li>
                      <li>
                        <Link
                          href="/code/dotnet/c-sharp/v13"
                          className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        >
                          <span className="ms-3">C# v13</span>
                        </Link>
                      </li>
                    </ul>
                  </AccordionContent>
        ...
        <div>
          ...
          <ul className="font-medium text-gray-500 dark:text-gray-400">
            ...
            <h2 className="mb-6 mt-5 text-sm font-semibold uppercase text-gray-900 dark:text-white">
              <Link href="/code/css-styles" className="hover:underline">
                CSS - Styles
              </Link>
            </h2>
          </ul>
